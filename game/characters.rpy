...
define ch_p_sprite_scale = (0.3, 0.3)
define ch_h_sprite_scale = (0.32, 0.32)

define ch_p = (CharacterController("plague", "Чума", "#b3bf4a")
    .add_state("normal", CharacterState([Sprite("plague normal", zoom=ch_p_sprite_scale)]))
    .add_state("normal sig", CharacterState([Sprite("plague normalsig", zoom=ch_p_sprite_scale)]))
    .add_state("cinema", CharacterState([Sprite("plague cinema", zoom=ch_p_sprite_scale)]))
    .add_state("cinema sig", CharacterState([Sprite("plague cinemasig", zoom=ch_p_sprite_scale)]))
    .add_state("happy", CharacterState([Sprite("plague happy", zoom=ch_p_sprite_scale)]))
    .add_state("happy sig", CharacterState([Sprite("plague happysig", zoom=ch_p_sprite_scale)]))
    .add_state("nervous", CharacterState([Sprite("plague nervous", zoom=ch_p_sprite_scale)]))
    .add_state("nervous sig", CharacterState([Sprite("plague nervoussig", zoom=ch_p_sprite_scale)]))
    .add_state("serious", CharacterState([Sprite("plague serious", zoom=ch_p_sprite_scale)]))
    .add_state("serious sig", CharacterState([Sprite("plague serioussig", zoom=ch_p_sprite_scale)]))
    .add_state("sad", CharacterState([Sprite("plague sad", zoom=ch_p_sprite_scale)]))
    .add_state("sad sig", CharacterState([Sprite("plague sadsig", zoom=ch_p_sprite_scale)]))
    .add_state("hidden", CharacterState([Sprite("empty", zoom=ch_p_sprite_scale)]))
    .set_position(250, 0)
)
